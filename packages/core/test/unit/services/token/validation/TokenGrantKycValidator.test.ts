...
import { TokenGrantKycValidator } from "../../../../../src/services/token/validation/index.js";
import type { TokenGrantKycOperationOptions } from "../../../../../src/services/token/operations/index.js";

describe("TokenGrantKycValidator", () => {
    const validator = new TokenGrantKycValidator();

    const baseOptions: TokenGrantKycOperationOptions = {
        tokenId: "0.0.456",
        accountId: "0.0.123",
    };
