...
import { TokenRevokeKycValidator } from "../../../../../src/services/token/validation/index.js";
import type { TokenRevokeKycOperationOptions } from "../../../../../src/services/token/operations/index.js";

describe("TokenRevokeKycValidator", () => {
    const validator = new TokenRevokeKycValidator();

    const baseOptions: TokenRevokeKycOperationOptions = {
        tokenId: "0.0.456",
        accountId: "0.0.123",
    };
